...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShowsTracker.Domain.UserVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("VoteSeasonId");

                    b.ToTable("UserVote", (string)null);
                });

            modelBuilder.Entity("ShowsTracker.Domain.VoteSeason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VoteSeason", (string)null);
                });

            modelBuilder.Entity("ShowsTracker.Domain.VoteShow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VoteShow", (string)null);
                });
            ...
            modelBuilder.Entity("ShowsTracker.Domain.UserVote", b =>
                {
                    ...
                    b.HasOne("ShowsTracker.Domain.VoteSeason", "VoteSeason")
                        .WithMany("UserVotes")
                        .HasForeignKey("VoteSeasonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
